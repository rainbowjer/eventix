...
<style>
    ...
    .profile-avatar {
        ...
        box-shadow: 0 2px 8px #a259f722; /* Removed the large glow shadow */
        margin-bottom: 1rem;
        background: #f3eaff;
        /* Removed animation and transition for avatarGlow */
    }
    .role-badge {
...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        <img src="{{ asset('images/eventix-logo.png') }}" class="rounded-circle shadow" width="100" alt="Profile Avatar">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7">
                    <div class="profile-card mb-4">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteAccountModal" aria-label="Delete My Account">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-0">
                    <strong>Warning:</strong> This action cannot be undone. Once your account is deleted, all of its resources and data will be permanently removed. Please back up anything important before proceeding.
                </p>
            </div>
